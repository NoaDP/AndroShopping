...
public class CustomAdapter extends ArrayAdapter<ProductModel>{
    ...
    private void populate(Context context) {
        ...
        this.products.add(new ProductModel("Xbox", 199,context.getString(R.string.descXBOX)));
        this.products.add(new ProductModel("Sony", 299,context.getString(R.string.descSony)));
        this.products.add(new ProductModel("Mac book pro", 1990,context.getString(R.string.descMac)));
        this.products.add(new ProductModel("Acer P400", 399,context.getString(R.string.descAcer)));
        this.products.add(new ProductModel("Nexus 4", 200,context.getString(R.string.descNexus)));
        this.products.add(new ProductModel("iPad 4", 399,context.getString(R.string.desciPad)));
    }
